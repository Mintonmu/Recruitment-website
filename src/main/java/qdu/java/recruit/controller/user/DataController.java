...
public class DataController extends BaseController {
    ...
    @ResponseBody
    public int userRegister(@RequestParam String mobile, @RequestParam String password, @RequestParam String nickName, @RequestParam int type) {
        ...
        if (type == 2) {
            if (hrService.getHRByName(nickName) != null) {
                return 0;
            }
...
//        UserEntity user = this.getUser(request);
    ...
    public String updateInfo(HttpServletRequest request, @RequestParam("password") String password, @RequestParam("nickname") String nickname,
                             @RequestParam("email") String email, @RequestParam("name") String name, @RequestParam("gender") String gender,
                             @RequestParam("birthYear") String birthYear, @RequestParam("graYear") String graYear, @RequestParam("province") String province,
                             @RequestParam("city") String city, @RequestParam("eduDegree") String eduDegree, @RequestParam("graduation") String graduation,
                             @RequestParam("major") String major, @RequestParam("dirDesire") String dirDesire) {
        ...
        userEntity.setGender(Integer.parseInt(gender));
        userEntity.setBirthYear(Integer.parseInt(birthYear));
        userEntity.setGraYear(Integer.parseInt(graYear));
        ...
        userEntity.setDirDesire(Integer.parseInt(dirDesire));
